...
class EvolutionaryService:
    def evaluation(self, solution, frequencies, data, gmapsClient):
        sum = 0.000
    ...
    def getBestLocation(self, data, gmapsClient):
        '''
        ...
        pop.init_pop()
        for i in range(100):
            best,converged = pop.evolve(self.evaluation,frequencies,coords,2)
            if converged:
